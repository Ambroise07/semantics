...
import argparse
import core
from model import TextGenerator  # Assuming TextGenerator is saved inside model.py
...
def main():
    ...
    # New argument option to trigger embedding visualization chart
    parser.add_argument('--plot', action='store_true',
                        help='Display the 2D scatter plot visualization of the character embeddings lookup table (default: False)')
    ...
    # 4. Trigger embedding visualization if the --plot flag is present in cmd
    if args.plot:
        print("📈 Launching matplotlib window to display 2D character clusters...")
        model.plot_embedings()
